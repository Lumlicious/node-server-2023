...
-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_blongsToId_fkey" FOREIGN KEY ("blongsToId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
